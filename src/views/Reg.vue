<template>
  <div class="dt-reg-wrap">
    <div class="flex flex-wrap w-full">
      <div class="flex flex-col w-full md:w-1/2 bg-shrub">
        <div class="flex flex-col justify-center w-1/2 mx-auto bg-white opacity-80 px-8 pt-8 pb-8 my-auto md:justify-start md:pt-0 dt-transform-scale">
      ...
      <div class="w-1/2 shadow-2xl">
        <img class="hidden object-cover w-full h-screen md:block" src="@/assets/img/door.jpg"/>
      </div>
    </div>
  </div>
</template>
...
<style scoped>
.bg-shrub {
  background-image: url('@/assets/img/door.jpg');
